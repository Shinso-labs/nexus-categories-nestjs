...
import { BlogModuleController } from './blog.controller';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([BlogPost, Author, BlogIndex, PostSummary, AuthorSummary, BlogConfig, CategoryIndex, PostCategory, PostMetrics]),
  ],
  controllers: [BlogModuleController],
